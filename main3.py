...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if user_id not in user_data:
        user_data[user_id] = {
            "nombre_usuario": None,
            "meta": None,
            "estado": "inicial"  # Estados: esperando_saludo, esperando_usuario, esperando_meta, listo
        }
    ...
    if intencion == "Cambiar de cuenta":
        ...
        await update.message.reply_text("Claro, reiniciando. Envía un mensaje para continuar...")
    ...
    if estado == "esperando_usuario":
        ...
        if posible_usuario:
            # Verificar si el usuario es "unioficial" y asignar "UNI"
            if posible_usuario == "unioficial":
                posible_usuario = "UNI"
